 ...
 * handshake (the `xmlns="md"` IQ exchange + commit/reveal ECDH).
 */
const makeShortcakeFlow = (opts) => {
         ...
         * the ADV secret (matching the official clients).
         */
        ...
        /**
         * Routes the two server-pushed Shortcake notifications.
         */
